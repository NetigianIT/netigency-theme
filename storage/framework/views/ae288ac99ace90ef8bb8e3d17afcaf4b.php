                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        <option value="with_this_account" selected><?php echo e(__('content.select_your_option')); ?></option>
                                        <option value="with_this_account"><?php echo e(__('content.with_this_account')); ?></option>
                                        <option value="anonymous"><?php echo e(__('content.anonymous')); ?></option>
                                    </select>
                                </div>
                            </div>
