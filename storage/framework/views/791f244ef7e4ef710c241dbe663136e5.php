    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" aria-label="Admin menu">
            ...
            <ul class="nav">
                ...
                <li class="nav-item  <?php echo e(request()->is('admin/feature*') ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('feature.index')); ?>">
                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('services check')): ?>
                    <li class="nav-item <?php echo e((request()->is('admin/service*') || request()->is('admin/service-detail*') || request()->is('admin/service-paginate*')) ? 'active' : ''); ?>">
                ...
                <li class="nav-item  <?php echo e((request()->is('admin/skill/*') ||
                                         request()->is('admin/skill-info-list') ||
                                         request()->is('admin/skill-info-list/*')) ? 'active' : ''); ?>">
                    <a class="nav-link" href="<?php echo e(route('skill.create')); ?>">
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($needsAdminTables): ?>
    ...
    <script src="<?php echo e(asset('assets/admin/side_menu/js/default-assets/demo.datatable-init.js')); ?>?v=17" defer></script>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($needsAdminEditor): ?>
    ...
    <script src="<?php echo e(asset('assets/admin/side_menu/js/ni-editor.js')); ?>?v=7" defer></script>
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
<script>
    ...
    function copyImageLink(id) {
        ...
        if (typeof toastr !== 'undefined') {
            toastr.success("<?php echo e(__('content.copied_text')); ?>" + ": " + copyText.value, "<?php echo e(__('Success')); ?>");
        } else {
