...
$fallback = [
    ...
    */
    ...
    'title' => 'Title',
    'hero_title_help' => 'Static headline text shown before the typing animation (example: We Build Modern).',
    'animated_title' => 'Animated Title',
    'animated_titles_help' => 'Up to 4 titles rotate with a typing animation after the main title. Leave blank to skip.',
    ...
    'particles_status' => 'Particles.js Effect',
    'particles_status_help' => 'Turn the hero area Particles.js background animation on or off.',
    'hero_content_required_for_particles' => 'Please create Hero Fixed Content first, then you can enable or disable the Particles.js effect here.',
    'thumbnail_dark' => 'Dark Mode Image',
    'thumbnail_light' => 'Light / White Mode Image',
    'image_light_help' => 'Upload a separate image with a white / light background for light mode. Dark mode image should use a dark background.',
    'thumbnail' => 'Thumbnail',
    'sliders' => 'Sliders',
    ...
    'supporting_stack' => 'Supporting Stack',
    'type' => 'Type',
    ...
    'add_page' => 'Add Page',
    'edit_page' => 'Edit Page',
    'page_limit_reached' => 'You can create a maximum of :max pages.',
    'page_limit_hint' => 'Maximum :max pages allowed. Currently :count / :max.',
