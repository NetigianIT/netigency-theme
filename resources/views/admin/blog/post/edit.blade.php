                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input id="meta_desc" name="meta_desc" type="text" class="form-control" value="{{ $blog->meta_desc }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        @if (!empty($blog->custom_breadcrumb_image))
                                                            <div class="mb-2">
                                                                <img src="{{ asset('uploads/img/blogs/breadcrumb/'.$blog->custom_breadcrumb_image) }}" alt="breadcrumb" class="rounded img-fluid" style="max-height: 80px;">
                                                            </div>
                                                        @endif
                                                    </div>
                                                </div>
