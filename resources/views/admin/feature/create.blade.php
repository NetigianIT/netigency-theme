                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="stack" class="form-control" id="stack" required>
                                        <option value="main" @selected(old('stack') === 'main')>{{ __('content.main_stack') }}</option>
                                        <option value="supporting" @selected(old('stack', 'supporting') === 'supporting')>{{ __('content.supporting_stack') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-12">
