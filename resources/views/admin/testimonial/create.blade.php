...
@section('page_actions')
    <button type="button" class="btn btn-primary mr-2" data-toggle="modal" data-target="#testimonialSectionModal">{{ __('content.section_title_and_desc') }}</button>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#testimonialModal">+ {{ __('content.add_testimonial') }}</button>
@endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" id="title" value="{{ $testimonial_section->title }}" required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
