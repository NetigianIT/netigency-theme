                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="meta_desc" name="meta_desc" type="text" class="form-control" value="{{ old('meta_desc', $service->meta_desc) }}">
                                </div>
                                <div class="form-group">
                                    <label for="meta_keyword">{{ __('content.meta_keyword') }} ({{ __('content.separate_with_commas') }})</label>
                                    <textarea id="meta_keyword" name="meta_keyword" class="form-control">{{ old('meta_keyword', $service->meta_keyword) }}</textarea>
                                </div>
                            </div>
