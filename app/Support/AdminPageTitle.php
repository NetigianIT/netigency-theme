...
class AdminPageTitle
{
    ...
    public static function resolve(?string $path = null): array
    {
        ...
        $items = [
            ...
            'admin/subscribe' => ['title' => __('content.subscribers'), 'icon' => 'fas fa-at'],
            'admin/fixed-content' => ['title' => __('content.fixed_content'), 'icon' => 'fas fa-desktop'],
            'admin/slider' => ['title' => __('content.sliders'), 'icon' => 'fas fa-images'],
            'admin/video' => ['title' => __('content.video'), 'icon' => 'fas fa-video'],
            'admin/homepage-version' => ['title' => __('content.homepage_versions'), 'icon' => 'fas fa-layer-group'],
            'admin/external-url' => ['title' => __('content.external_url'), 'icon' => 'fas fa-external-link-square-alt'],
            ...
            'admin/work-process' => ['title' => __('content.work_processes'), 'icon' => 'fas fa-pen-alt'],
            'admin/skill' => ['title' => __('content.skill'), 'icon' => 'fas fa-tools'],
            'admin/skill-info-list' => ['title' => __('content.skill'), 'icon' => 'fas fa-tools'],
            ...
            'admin/breadcrumb' => ['title' => __('content.breadcrumb'), 'icon' => 'fas fa-ellipsis-h'],
            'admin/section' => ['title' => __('content.sections'), 'icon' => 'fas fa-th-large'],
            'admin/color-option' => ['title' => __('content.color_option'), 'icon' => 'fas fa-palette'],
